                                ...
                                <tbody>
                                    <?php
                                        ...
                                        foreach (dbquery('SELECT * FROM servers') as $server) {
                                            $servers++;
                                            if(checkOnline($server['connection']) == true) { $status = "<span class='label label-success'>Online</span>"; } else { $status = "<span class='label label-danger'>Offline</span>"; }
                                            echo '
                                                <tr>
                                                    <td>'.$server['name'].'</td>
                                                    ...
                                                    <form action="'.$GLOBALS['domainname'].'api/delserver" method="post" onsubmit="return submitForm($(this));">
                                                        ...
                                                        <td><span class="label label-warning" onclick=\'$("#remove-server-'.$server['ID'].'").click();\' style="cursor: pointer;">Remove</span></td>
                                                    </form>
                                                </tr>
                                            ';
                                        }
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Server IP" name="serverip">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Server Port</label>
                                            <input type="text" class="form-control" placeholder="Server Port" name="serverport">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>RCON Password</label>
                                            <input type="text" class="form-control" placeholder="RCON Password" name="serverrcon">
                                        </div>
                                    </div>
                                </div>
                                <div id="message"></div>
                                <button type="submit" class="btn btn-info btn-fill" style="width: 100%;">Add Server</button>

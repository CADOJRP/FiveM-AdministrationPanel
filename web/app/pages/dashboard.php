		...
		<div class="content">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-3">
						<a class="info-tiles tiles-inverse has-footer" href="#">
							...
							<div class="tiles-body">
								<div class="text-center"><?php echo $this->stats['warns']; ?></div>
							</div>
					...
					<div class="col-md-3">
						<a class="info-tiles tiles-green has-footer" href="#">
							...
							<div class="tiles-body">
								<div class="text-center"><?php echo $this->stats['kicks']; ?></div>
							</div>
							<div class="tiles-footer"></div>
						</a>
					</div>
					<div class="col-md-3">
						<a class="info-tiles tiles-blue has-footer" href="#">
							...
							<div class="tiles-body">
								<div class="text-center"><?php echo $this->stats['bans']; ?></div>
							</div>
							<div class="tiles-footer"></div>
						</a>
					</div>
					<div class="col-md-3">
						<a class="info-tiles tiles-midnightblue has-footer" href="#">
							...
							<div class="tiles-body">
								<div class="text-center"><?php echo $this->players; ?></div>
							</div>
							<div class="tiles-footer"></div>
						</a>
					</div>
				...
				<?php
					...
					if($version->webpanel > 0.0) {
						echo '
							<div class="row">
								<div class="col-md-12">
									<div class="alert alert-danger info-tiles">
										<strong>Update Needed!</strong> We strongly advise updating as we are currently in our beta stages and will be resolving major flaws. <a href="https://github.com/CADOJRP/FiveM-AdministrationPanel/releases" target="_BLANK" style="color: #FFF;"><b><u>Download Update</u></b></a>
									</div>
								</div>
							</div>
						';
					...
					echo file_get_contents('https://raw.githubusercontent.com/CADOJRP/FiveM-AdministrationPanel/master/updates');
				?>
			</div>
		</div>
		<footer class="footer">
